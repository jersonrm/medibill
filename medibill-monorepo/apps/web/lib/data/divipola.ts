export interface Departamento {
  codigo: string; // 2-digit department code
  nombre: string;
}

export interface Municipio {
  codigo: string; // 5-digit DIVIPOLA code
  nombre: string;
}
...
export const MUNICIPIOS: Record<string, Municipio[]> = {
  ...
  "05": [
    ...
    { codigo: "05150", nombre: "Carolina del Príncipe" },
  ...
  "13": [
    ...
    { codigo: "13473", nombre: "Montecristo" },
    { codigo: "13490", nombre: "Morales" },
  ...
  "52": [
    ...
    { codigo: "52210", nombre: "Colón (Génova)" },
    { codigo: "52224", nombre: "Córdoba (Nariño)" },
    { codigo: "52227", nombre: "Cuaspud" },
    { codigo: "52233", nombre: "Cumbal" },
    ...
    { codigo: "52418", nombre: "Los Andes (Sotomayor)" },
    { codigo: "52427", nombre: "Magüí Payán" },
    ...
    { codigo: "52696", nombre: "Santa Bárbara (Iscuandé)" },
    { codigo: "52699", nombre: "Santacruz (Guachavés)" },
...
/**
 * Helper: find a department by its 2-digit code.
 */
export function getDepartamento(codigo: string): Departamento | undefined {
  return DEPARTAMENTOS.find((d) => d.codigo === codigo);
}

/**
 * Helper: get municipalities for a given 2-digit department code.
 */
export function getMunicipios(codigoDepartamento: string): Municipio[] {
  return MUNICIPIOS[codigoDepartamento] ?? [];
}

/**
 * Helper: find a municipality by its 5-digit DIVIPOLA code.
 */
export function getMunicipio(codigoDivipola: string): Municipio | undefined {
  const codigoDepartamento = codigoDivipola.substring(0, 2);
  const municipios = MUNICIPIOS[codigoDepartamento];
  if (!municipios) return undefined;
  return municipios.find((m) => m.codigo === codigoDivipola);
}

/**
 * Helper: get the department code from a 5-digit DIVIPOLA municipality code.
 */
export function getCodigoDepartamento(codigoDivipola: string): string {
  return codigoDivipola.substring(0, 2);
}
